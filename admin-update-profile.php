...
if(isset($_SESSION['logged-in'])) {
    ...
    {
        $updateQuerry = "UPDATE admin SET Username = '$_POST[Username]' ,FirstName = '$_POST[FirstName]', Surname = '$_POST[Surname]'  WHERE Username = '$user'";
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            $profileData= mysqli_query($conn, "select Username, FirstName, Surname, Password  from admin where Username = '$user'");
